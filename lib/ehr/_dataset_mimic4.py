...
from ._dataset_sql_mimic4 import MIMIC4ICUDatasetScheme, MIMIC4DatasetScheme
...
class SampleSubjects(DatasetTransformation):
    ...
    def __call__(self, dataset: MIMIC4ICUDataset, aux: Dict[str, Any]) -> Tuple[MIMIC4ICUDataset, Dict[str, str]]:
        pass
...
class SyncAdmissions(DatasetTransformation):
    def __call__(self, dataset: MIMIC4ICUDataset, aux: Dict[str, Any]) -> Tuple[MIMIC4ICUDataset, Dict[str, str]]:
        pass
...
class SetCodeIndex(DatasetTransformation):
    def __call__(self, dataset: MIMIC4ICUDataset, aux: Dict[str, Any]) -> Tuple[MIMIC4ICUDataset, Dict[str, str]]:
        pass
...
class ObsScaler(DatasetTransformation):
    ...
    def __call__(self, dataset: MIMIC4ICUDataset, aux: Dict[str, Any]) -> Tuple[MIMIC4ICUDataset, Dict[str, Any]]:
        pass

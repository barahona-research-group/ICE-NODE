...
class SNONETDiagStat(BatchedApply):
...
def eval_fn(ode_model: SNONETDiagStat, loss_mixing: Dict[str, float],
...
def loss_fn(ode_model: SNONETDiagStat, loss_mixing: Dict[str, float],
...
def train_ehr(
    ...
    ode_model = SNONETDiagStat(subject_interface=subject_interface,
                               diag_gram=diag_gram,
                               **model_config,
                               tay_reg=tay_reg,
                               diag_loss=diag_loss)

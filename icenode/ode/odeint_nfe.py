...
def optimal_step_size(last_step,
    ...
    return np.where(mean_error_ratio == 0, last_step * ifactor,
                    last_step / factor)
...
def _odeint_rev(func, rtol, atol, mxstep, res, g):
    ...
    def scan_fun(carry, i):
        ...
        _, y_bar, t0_bar, args_bar = odeint(aug_dynamics,
                                            ...
                                            *args,
                                            ...
                                            atol=atol,
                                            mxstep=mxstep)[0]
        y_bar, t0_bar, args_bar = tree_map(op.itemgetter(1),
    ...
    (y_bar, t0_bar,
     args_bar), rev_ts_bar = lax.scan(scan_fun, init_carry,
                                      np.arange(len(ts) - 1, 0, -1))
